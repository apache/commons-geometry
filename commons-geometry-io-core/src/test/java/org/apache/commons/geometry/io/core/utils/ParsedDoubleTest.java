...
public class ParsedDoubleTest {
    ...
    public void testFrom_notFinite() {
        ...
        // act/assert
        GeometryTestUtils.assertThrowsWithMessage(() -> ParsedDouble.from(Double.NaN),
                IllegalArgumentException.class, msg);
        GeometryTestUtils.assertThrowsWithMessage(() -> ParsedDouble.from(Double.NEGATIVE_INFINITY),
                IllegalArgumentException.class, msg);
        GeometryTestUtils.assertThrowsWithMessage(() -> ParsedDouble.from(Double.POSITIVE_INFINITY),
                IllegalArgumentException.class, msg);
    }
