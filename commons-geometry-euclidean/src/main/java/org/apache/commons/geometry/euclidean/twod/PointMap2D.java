...
/** {@link PointMap} type for Euclidean 2D space.
 * @param <V> Map value type
 */
public interface PointMap2D<V> extends PointMap<Vector2D, V> {
     ...
     */
    static <V> PointMap2D<V> of(final Precision.DoubleEquivalence precision) {
