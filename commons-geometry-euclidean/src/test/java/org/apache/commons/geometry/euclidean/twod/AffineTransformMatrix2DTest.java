...
public class AffineTransformMatrix2DTest {
    ...
    public void testOf_invalidDimensions() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  AffineTransformMatrix2D.of(1, 2),  "Dimension mismatch: 2 != 6");
    }
    ...
    public void testFrom_invalidFunction() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () -> AffineTransformMatrix2D.from(v -> v.multiply(0)));
    }
    ...
    public void testApplyDirection_illegalNorm() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () -> AffineTransformMatrix2D.createScale(1, 0).applyDirection(Vector2D.Unit.PLUS_Y));
        assertThrows(IllegalArgumentException.class, () -> AffineTransformMatrix2D.createScale(2).applyDirection(Vector2D.ZERO));
    }
    ...
    public void testInverse_nonInvertible() {
        // act/assert
        assertThrows(IllegalStateException.class, () ->  AffineTransformMatrix2D.of(
                0, 0, 0,
                0, 0, 0).inverse(),  "Matrix is not invertible; matrix determinant is 0.0");
        assertThrows(IllegalStateException.class, () ->  AffineTransformMatrix2D.of(
                1, 0, 0,
                0, Double.NaN, 0).inverse(),  "Matrix is not invertible; matrix determinant is NaN");
        assertThrows(IllegalStateException.class, () ->  AffineTransformMatrix2D.of(
                1, 0, 0,
                0, Double.NEGATIVE_INFINITY, 0).inverse(),  "Matrix is not invertible; matrix determinant is -Infinity");
        assertThrows(IllegalStateException.class, () ->  AffineTransformMatrix2D.of(
                Double.POSITIVE_INFINITY, 0, 0,
                0, 1, 0).inverse(),  "Matrix is not invertible; matrix determinant is Infinity");
        assertThrows(IllegalStateException.class, () ->  AffineTransformMatrix2D.of(
                1, 0, Double.NaN,
                0, 1, 0).inverse(),  "Matrix is not invertible; invalid matrix element: NaN");
        assertThrows(IllegalStateException.class, () ->  AffineTransformMatrix2D.of(
                1, 0, Double.POSITIVE_INFINITY,
                0, 1, 0).inverse(),  "Matrix is not invertible; invalid matrix element: Infinity");
        assertThrows(IllegalStateException.class, () ->  AffineTransformMatrix2D.of(
    ...
    public void testNormalTransform_nonInvertible() {
        // act/assert
        assertThrows(IllegalStateException.class, () -> AffineTransformMatrix2D.createScale(0).normalTransform());
    }
