...
public class CharacterizationTest {
    ...
    public void testCharacterize_insideLeaf() {
        ...
        SubLine_Old sub = buildSubLine(Vector2D.of(0, -1), Vector2D.of(0, 1));
    ...
    public void testCharacterize_onPlusSide() {
        ...
        SubLine_Old sub = buildSubLine(Vector2D.of(0, -1), Vector2D.of(0, -2));
    ...
    public void testCharacterize_onBothSides() {
        ...
        SubLine_Old inside = (SubLine_Old) ch.insideTouching();
        ...
        SubLine_Old outside = (SubLine_Old) ch.outsideTouching();
    ...
    public void testCharacterize_multipleSplits_reunitedOnPlusSide() {
        ...
        SubLine_Old sub = buildSubLine(Vector2D.of(0, -2), Vector2D.of(0, 2));
    ...
    public void testCharacterize_onHyperplane_sameOrientation() {
        ...
        SubLine_Old sub = buildSubLine(Vector2D.of(0, 0), Vector2D.of(1, 0));
    ...
    public void testCharacterize_onHyperplane_oppositeOrientation() {
        ...
        SubLine_Old sub = buildSubLine(Vector2D.of(1, 0), Vector2D.of(0, 0));
    ...
    public void testCharacterize_onHyperplane_multipleSplits_sameOrientation() {
        ...
        SubLine_Old sub = buildSubLine(Vector2D.of(-2, 0), Vector2D.of(2, 0));
    ...
    private void cut(BSPTree_Old<Vector2D> tree, Line_Old line) {
    ...
    private Line_Old buildLine(Vector2D p1, Vector2D p2) {
        return Line_Old.fromPoints(p1, p2, TEST_PRECISION);
    }

    private SubLine_Old buildSubLine(Vector2D start, Vector2D end) {
