...
public class QuaternionRotationTest {
    ...
    public void testOf_quaternion_illegalNorm() {
        // act/assert
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(Quaternion.of(0, 0, 0, 0)));
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(Quaternion.of(1, 1, 1, Double.NaN)));
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(Quaternion.of(1, 1, Double.POSITIVE_INFINITY, 1)));
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(Quaternion.of(1, Double.NEGATIVE_INFINITY, 1, 1)));
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(Quaternion.of(Double.NaN, 1, 1, 1)));
    }
    ...
    public void testOf_components_illegalNorm() {
        // act/assert
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(0, 0, 0, 0));
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(1, 1, 1, Double.NaN));
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(1, 1, Double.POSITIVE_INFINITY, 1));
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(1, Double.NEGATIVE_INFINITY, 1, 1));
        assertThrows(IllegalStateException.class, () -> QuaternionRotation.of(Double.NaN, 1, 1, 1));
    }
    ...
    public void testGetAngle() {
        ...
        Assertions.assertEquals(PlaneAngleRadians.PI_OVER_TWO, QuaternionRotation.of(1, 0, 0, 1).getAngle(), EPS);
        Assertions.assertEquals(PlaneAngleRadians.PI_OVER_TWO, QuaternionRotation.of(-1, 0, 0, -1).getAngle(), EPS);

        Assertions.assertEquals(PlaneAngleRadians.PI  * 2.0 / 3.0, QuaternionRotation.of(1, 1, 1, 1).getAngle(), EPS);

        Assertions.assertEquals(PlaneAngleRadians.PI, QuaternionRotation.of(0, 0, 0, 1).getAngle(), EPS);
    }
    ...
    public void testFromAxisAngle_invalidAxisNorm() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.fromAxisAngle(Vector3D.ZERO, PlaneAngleRadians.PI_OVER_TWO));
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.fromAxisAngle(Vector3D.NaN, PlaneAngleRadians.PI_OVER_TWO));
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.fromAxisAngle(Vector3D.POSITIVE_INFINITY, PlaneAngleRadians.PI_OVER_TWO));
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.fromAxisAngle(Vector3D.NEGATIVE_INFINITY, PlaneAngleRadians.PI_OVER_TWO));
    }

    @Test
    public void testFromAxisAngle_invalidAngle() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  QuaternionRotation.fromAxisAngle(Vector3D.Unit.PLUS_X, Double.NaN),  "Invalid angle: NaN");
        assertThrows(IllegalArgumentException.class, () ->  QuaternionRotation.fromAxisAngle(Vector3D.Unit.PLUS_X, Double.POSITIVE_INFINITY),  "Invalid angle: Infinity");
        assertThrows(IllegalArgumentException.class, () ->  QuaternionRotation.fromAxisAngle(Vector3D.Unit.PLUS_X, Double.NEGATIVE_INFINITY),  "Invalid angle: -Infinity");
    }
    ...
    public void testMultiply_sameAxis_simple() {
        ...
        Assertions.assertEquals(PlaneAngleRadians.PI_OVER_TWO, result.getAngle(), EPS);
    ...
    public void testMultiply_sameAxis_multiple() {
        ...
        Assertions.assertEquals(2.0 * PlaneAngleRadians.PI / 3.0, result.getAngle(), EPS);
    ...
    public void testSlerp_followsShortestPath() {
        ...
        Assertions.assertEquals(PlaneAngleRadians.PI, result.getAngle(), EPS);
    }
    ...
    public void testToAxisAngleSequence_invalidArgs() {
        ...
        // act/assert
        assertThrows(IllegalArgumentException.class, () -> q.toAxisAngleSequence(null, AxisSequence.XYZ));
        assertThrows(IllegalArgumentException.class, () -> q.toAxisAngleSequence(AxisReferenceFrame.ABSOLUTE, null));
    }
    ...
    public void testToRelativeAxisAngleSequence() {
        ...
        Assertions.assertEquals(PlaneAngleRadians.PI_OVER_TWO, seq.getAngle1(), EPS);
        Assertions.assertEquals(PlaneAngleRadians.PI_OVER_TWO, seq.getAngle2(), EPS);
    ...
    public void testToAbsoluteAxisAngleSequence() {
        ...
        Assertions.assertEquals(PlaneAngleRadians.PI_OVER_TWO, seq.getAngle3(), EPS);
    }
    ...
    public void testCreateVectorRotation_simple() {
        ...
        Assertions.assertEquals(PlaneAngleRadians.PI_OVER_TWO, q.getAngle(), EPS);
    ...
    public void testCreateVectorRotation_antiparallel() {
        ...
        Assertions.assertEquals(PlaneAngleRadians.PI, q.getAngle(), EPS);
    ...
    public void testCreateVectorRotation_invalidArgs() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.createVectorRotation(Vector3D.ZERO, Vector3D.Unit.PLUS_X));
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.createVectorRotation(Vector3D.Unit.PLUS_X, Vector3D.ZERO));
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.createVectorRotation(Vector3D.NaN, Vector3D.Unit.PLUS_X));
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.createVectorRotation(Vector3D.Unit.PLUS_X, Vector3D.POSITIVE_INFINITY));
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.createVectorRotation(Vector3D.Unit.PLUS_X, Vector3D.NEGATIVE_INFINITY));
    }
    ...
    public void testCreateBasisRotation_invalidArgs() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () -> QuaternionRotation.createBasisRotation(
