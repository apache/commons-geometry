...
public class Ray3DTest {
    ...
    public void testFromPointAndDirection_invalidArgs() {
        ...
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.rayFromPointAndDirection(pt, dir, TEST_PRECISION),  "Line direction cannot be zero");
    }
    ...
    public void testFromPoint_invalidArgs() {
        ...
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.rayFromPoint(line, Vector3D.NaN),  "Invalid ray start location: NaN");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.rayFromPoint(line, Vector3D.NEGATIVE_INFINITY),  "Invalid ray start location: NaN");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.rayFromPoint(line, Vector3D.POSITIVE_INFINITY),  "Invalid ray start location: NaN");
    }
