...
public class IntervalTest {
    ...
    public void testOf_doubles_invalidIntervals() {
        ...
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(1, Double.NaN, TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(Double.NaN, 1, TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(Double.NaN, Double.NaN, TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, TEST_PRECISION));
    }
    ...
    public void testOf_points_invalidIntervals() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(Vector1D.of(1), Vector1D.of(Double.NaN), TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(Vector1D.of(Double.POSITIVE_INFINITY), Vector1D.of(Double.POSITIVE_INFINITY), TEST_PRECISION));
    }
    ...
    public void testOf_hyperplanes_invalidArgs() {
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(
                OrientedPoints.fromLocationAndDirection(1, false, TEST_PRECISION),
                OrientedPoints.fromLocationAndDirection(1, false, TEST_PRECISION)));
        assertThrows(IllegalArgumentException.class, () ->  Interval.of(
                OrientedPoints.fromLocationAndDirection(2, false, TEST_PRECISION),
    ...
    public void testPoint_invalidArgs() {
        ...
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Interval.point(Double.NEGATIVE_INFINITY, TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.point(Double.POSITIVE_INFINITY, TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.point(Double.NaN, TEST_PRECISION));
    }
    ...
    public void testMin_invalidArgs() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Interval.min(Double.POSITIVE_INFINITY, TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.min(Double.NaN, TEST_PRECISION));
    }
    ...
    public void testMax_invalidArgs() {
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Interval.max(Double.NEGATIVE_INFINITY, TEST_PRECISION));
        assertThrows(IllegalArgumentException.class, () ->  Interval.max(Double.NaN, TEST_PRECISION));
    }
