...
public class Segment3DTest {
    ...
    public void testFromPoints_invalidArgs() {
        ...
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromPoints(p1, p1, TEST_PRECISION),  "Line direction cannot be zero");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromPoints(p1, p2, TEST_PRECISION),  "Line direction cannot be zero");
    }
    ...
    public void testFromPoints_givenLine_invalidArgs() {
        ...
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromPoints(line, Vector3D.NaN, p1),  "Invalid line segment locations: NaN, 2.0");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromPoints(line, p0, Vector3D.NaN),  "Invalid line segment locations: 1.0, NaN");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromPoints(line, Vector3D.NEGATIVE_INFINITY, p1),  "Invalid line segment locations: NaN, 2.0");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromPoints(line, p0, Vector3D.POSITIVE_INFINITY),  "Invalid line segment locations: 1.0, NaN");
    }
    ...
    public void testFromLocations_invalidArgs() {
        ...
        // act/assert
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromLocations(line, Double.NaN, 2),  "Invalid line segment locations: NaN, 2.0");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromLocations(line, 1, Double.NaN),  "Invalid line segment locations: 1.0, NaN");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromLocations(line, Double.NEGATIVE_INFINITY, 2),  "Invalid line segment locations: -Infinity, 2.0");
        assertThrows(IllegalArgumentException.class, () ->  Lines3D.segmentFromLocations(line, 1, Double.POSITIVE_INFINITY),  "Invalid line segment locations: 1.0, Infinity");
    }
