...
class Vector2DTest {
  ...
  void testOf() {
    ...
    checkVector(Vector2D.of(Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY), Double.POSITIVE_INFINITY,
  ...
  void testOf_arrayArg() {
    ...
    checkVector(Vector2D.of(new double[] {Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY}),
  ...
  void testMax() {
    ...
    EuclideanTestUtils.assertCoordinatesEqual(Vector2D.of(0, 1),
                                              Vector2D.max(Arrays.asList(Vector2D.of(-100, 1), Vector2D.of(0, 1))),
                                              EPS);

    EuclideanTestUtils.assertCoordinatesEqual(Vector2D.of(-1, 0),
                                              Vector2D.max(Vector2D.of(-2, 0), Vector2D.of(-1, -5),
                                                           Vector2D.of(-10, -10)), EPS);
  }
  ...
  void testMin() {
    ...
    EuclideanTestUtils.assertCoordinatesEqual(Vector2D.of(-100, 1),
                                              Vector2D.min(Arrays.asList(Vector2D.of(-100, 1), Vector2D.of(0, 1))),
                                              EPS);

    EuclideanTestUtils.assertCoordinatesEqual(Vector2D.of(-10, -10),
                                              Vector2D.min(Vector2D.of(-2, 0), Vector2D.of(-1, -5),
                                                           Vector2D.of(-10, -10)), EPS);
  }
