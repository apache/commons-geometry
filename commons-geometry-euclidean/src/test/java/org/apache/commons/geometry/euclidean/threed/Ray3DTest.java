...
public class Ray3DTest {
    ...
    public void testFromPointAndDirection() {
        ...
        // act
        Ray3D ray = Ray3D.fromPointAndDirection(pt, Vector3D.Unit.PLUS_Z, TEST_PRECISION);
    ...
    public void testFromPointAndDirection_invalidArgs() {
        ...
        GeometryTestUtils.assertThrows(() -> {
            Ray3D.fromPointAndDirection(pt, dir, TEST_PRECISION);
    ...
    public void testFromPoint() {
        ...
        // act
        Ray3D ray = Ray3D.fromPoint(line, pt);
    ...
    public void testFromPoint_invalidArgs() {
        ...
        // act/assert
        GeometryTestUtils.assertThrows(() -> {
            Ray3D.fromPoint(line, Vector3D.NaN);
        }, IllegalArgumentException.class, "Invalid ray start location: NaN");

        GeometryTestUtils.assertThrows(() -> {
            Ray3D.fromPoint(line, Vector3D.NEGATIVE_INFINITY);
        }, IllegalArgumentException.class, "Invalid ray start location: NaN");

        GeometryTestUtils.assertThrows(() -> {
            Ray3D.fromPoint(line, Vector3D.POSITIVE_INFINITY);
        }, IllegalArgumentException.class, "Invalid ray start location: NaN");
    }
    ...
    public void testFromLocation() {
        ...
        // act
        Ray3D ray = Ray3D.fromLocation(line, -1);
    ...
    public void testTransform() {
        ...
        Ray3D ray = Ray3D.fromPointAndDirection(Vector3D.of(1, 0, 0), Vector3D.Unit.PLUS_X, TEST_PRECISION);
    ...
    public void testContains() {
        ...
        Ray3D ray = Ray3D.fromPointAndDirection(Vector3D.of(1, 1, 1), Vector3D.Unit.PLUS_X, TEST_PRECISION);
    ...
    public void testGetInterval() {
        // arrange
        Ray3D ray = Ray3D.fromPointAndDirection(Vector3D.of(2, -1, 3), Vector3D.Unit.PLUS_Y, TEST_PRECISION);
    ...
    public void testToString() {
        // arrange
        Ray3D ray = Ray3D.fromPointAndDirection(Vector3D.ZERO, Vector3D.Unit.PLUS_X, TEST_PRECISION);
