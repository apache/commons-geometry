...
public class PolygonsSetTest {
    ...
    public void testLineIntersection() {
        ...
        // assert
        Line l1 = new Line(new Cartesian2D(-1.5, 0.0), Math.PI / 4, TEST_TOLERANCE);
    ...
    public void testThinRectangle_toleranceLessThanWidth_resultIsAccurate() {
        ...
        EuclideanTestUtils.assertPositiveInfinity(new RegionFactory<Euclidean2D>().getComplement(accuratePolygon).getSize());
