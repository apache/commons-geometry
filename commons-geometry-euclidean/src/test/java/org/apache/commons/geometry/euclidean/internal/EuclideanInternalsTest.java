...
public class EuclideanInternalsTest {
    ...
    public void testConvexPolygonToTriangleFan_threeVertices() {
        ...
        // act
        EuclideanInternals.convexPolygonToTriangleFan(Arrays.asList(p1, p2, p3), tris::add);
    ...
    public void testConvexPolygonToTriangleFan_fourVertices() {
        ...
        // act
        EuclideanInternals.convexPolygonToTriangleFan(Arrays.asList(p1, p2, p3, p4), tris::add);
    ...
    public void testConvexPolygonToTriangleFan_sixVertices() {
        ...
        // act
        EuclideanInternals.convexPolygonToTriangleFan(Arrays.asList(p1, p2, p3, p4, p5, p6), tris::add);
    ...
    public void testConvexPolygonToTriangleFan_notEnoughVertices() {
        ...
        GeometryTestUtils.assertThrowsWithMessage(() -> {
            EuclideanInternals.convexPolygonToTriangleFan(Collections.emptyList(), Function.identity());
        }, IllegalArgumentException.class, baseMsg + "0");

        GeometryTestUtils.assertThrowsWithMessage(() -> {
            EuclideanInternals.convexPolygonToTriangleFan(Collections.singletonList(Vector3D.ZERO), Function.identity());
        }, IllegalArgumentException.class, baseMsg + "1");

        GeometryTestUtils.assertThrowsWithMessage(() -> {
            EuclideanInternals.convexPolygonToTriangleFan(Arrays.asList(Vector3D.ZERO, Vector3D.of(1, 0, 0)), Function.identity());
