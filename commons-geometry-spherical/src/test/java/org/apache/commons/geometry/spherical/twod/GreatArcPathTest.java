...
public class GreatArcPathTest {
    ...
    public void testBuilder_points_noPrecisionGiven() {
        // act/assert
        assertThrows(IllegalStateException.class, () -> GreatArcPath.builder(null)
                .append(Point2S.PLUS_I)
                .append(Point2S.PLUS_J),  "Unable to create arc: no point precision specified");
        assertThrows(IllegalStateException.class, () -> GreatArcPath.builder(null)
                .prepend(Point2S.PLUS_I)
                .prepend(Point2S.PLUS_J),  "Unable to create arc: no point precision specified");
    }

    @Test
    public void testBuilder_arcsNotConnected() {
        // act/assert
        assertThrows(IllegalStateException.class, () ->  GreatArcPath.builder(TEST_PRECISION)
                .append(Point2S.PLUS_I)
                .append(Point2S.PLUS_J)
    ...
    public void testBuilder_cannotClose() {
        ...
        assertThrows(IllegalStateException.class, () -> GreatArcPath.builder(TEST_PRECISION)
                .append(GreatCircles.fromPoints(Point2S.PLUS_I, Point2S.PLUS_J, TEST_PRECISION).span())
                .close(),  "Unable to close path: path is full");
    }
