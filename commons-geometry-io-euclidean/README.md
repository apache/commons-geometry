...
More information can be found on the [Apache Commons Geometry Euclidean IO homepage](https://commons.apache.org/proper/commons-geometry).
The [Javadoc](https://commons.apache.org/proper/commons-geometry/apidocs) can be browsed.
Questions related to the usage of Apache Commons Geometry Euclidean IO should be posted to the [user mailing list][ml].
...
Donations
---------
You like Apache Commons Geometry Euclidean IO? Then [donate back to the ASF](https://www.apache.org/foundation/contributing.html) to support the development.
