...
public enum RegionCutRule {
    ...
    /** Defines the minus side of the cutting hyperplane as the inside of the region
     * and the plus side as the outside. This is the default convention for hyperplanes.
     */
    MINUS_INSIDE,

    /** Defines the plus side of the cutting hyperplane as the inside of the region and
     * the minus side as the outside.
     */
    PLUS_INSIDE,

    /** Does not define either side of the cutting hyperplane as inside or outside and
     * instead sets both sides to the same location as the parent node. For example, if the
